Реализовали изолированные Docker-контейнеры для Cards и Payments с запуском не от root, минимальной атакующей поверхностью и централизованным логированием через Portainer:
